...
class Controller extends BaseController
{
    ...
    public function enviarCorreoContacto($name, $email, $phone, $asuno, $mensaje)
    {
        ...
        try {
            ...
            $mail->AddEmbeddedImage(public_path() . '\images\mail\contacto.png', 'img_header', '/images/mail/contacto.png', 'base64', 'image/png');
            $mail->AddEmbeddedImage(public_path() . '\images\icons\facebook.png', "correo_facebook", '/images/icons/facebook.png', 'base64', 'image/png');
            $mail->AddEmbeddedImage(public_path() . '\images\icons\instagram.png', "correo_instagram", '/images/icons/instagram.png', 'base64', 'image/png');
            ...
            $mail->addAddress('dannygiancarlogc@gmail.com', $name);
            if ($mail->Send()) {
                return 200;
            } else {
                dd('error');
