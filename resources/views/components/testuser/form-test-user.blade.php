...
<div id="accordion">
    ...
    @foreach ($quesions as $key => $item)
        <div class="card mt-3 validateask">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 offset-md-3 ">
                        <p class="text-center"><strong>Responda Si o No</strong></p>
                        <div class="form-group row">
                            <div class="col-sm-6 ">
                                <div class="form-check">
                                    <label class="form-check-label">
                                    <input type="radio" class="form-check-input in" name="optionsRadios{{$key+1}}" id="optionsRadios1{{$key+1}}" value="1" required>
                                        Si
                            ...
                            <div class="col-sm-6">
                                <div class="form-check">
                                    <label class="form-check-label">
                                    <input type="radio" class="form-check-input in" name="optionsRadios{{$key+1}}" id="optionsRadios2{{$key+2}}" value="0" required>
                                        No
                                    <i class="input-helper"></i></label>
                                </div>
                            </div>
    ...
    @endforeach
    <div class="alert alert-warning alert-dismissible fade show smatext mt-2" style="display: none" role="alert">
        <strong>Ups!</strong> Revisa que todas las preguntas las fuera respondido.
